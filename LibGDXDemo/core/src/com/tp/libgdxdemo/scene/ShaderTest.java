...
import com.tp.libgdxdemo.util.PerspectiveCamController;
...
//        plane.setIndices(new short[] {3, 2, 1, 1, 0, 3});
        texture = new Texture(Gdx.files.internal("badlogic.jpg"), Format.RGB565, true);
    ...
    public void setupUI () {
        ...
        reload.addListener(new ClickListener() {
            public void clicked (InputEvent event, float x, float y) {
                ShaderProgram prog = new ShaderProgram(Gdx.files.internal("shaders//projtex-vert.glsl").readString(), Gdx.files
                        .internal("shaders//projtex-frag.glsl").readString());
    ...
    public void setupShaders () {
        ...
        projTexShader = new ShaderProgram(Gdx.files.internal("shaders//projtex-vert.glsl").readString(), Gdx.files.internal(
                "shaders//projtex-frag.glsl").readString());
    ...
    private void doneLoading()
    {
        ...
        plane = player.meshes.get(0);
        Gdx.app.debug("node", player.meshes.size + "111");
        loading = false;
    }
    @Override
    public void render () {
