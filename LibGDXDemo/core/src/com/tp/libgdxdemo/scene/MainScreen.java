...
import com.tp.libgdxdemo.Environment.DirectionalLight;
import com.tp.libgdxdemo.Environment.Light;
import com.tp.libgdxdemo.Environment.MovingPointLight;
import com.tp.libgdxdemo.Environment.PointLight;
import com.tp.libgdxdemo.ShaderProgram.ShadowMapShader;
import com.tp.libgdxdemo.ShaderProgram.SimpleTextureShader;
import com.tp.libgdxdemo.util.IntFirstPersonCameraController;
...
public class MainScreen implements Screen
{
    ...
    public ShaderProgram setupShader(final String prefix)
    {
        ...
        final ShaderProgram shaderProgram = new ShaderProgram(Gdx.files.internal("shaders/"  + prefix + "_v.glsl"), Gdx.files.internal("shaders/"  + prefix
                + "_f.glsl"));
